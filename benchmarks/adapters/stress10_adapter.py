...
class Stress10Adapter(BenchmarkAdapter):
    ...
    def __init__(self) -> None:
        ...
        self._observations = _stress10_observations(tenant, other_tenant)
        self._queries = _stress10_queries(tenant)
        self._gold = _gold_labels_by_query(self._queries)
...
def _stress10_queries(tenant: str) -> list[BenchmarkQuery]:
    return [
        BenchmarkQuery(
...
def _gold_labels_by_query(queries: list[BenchmarkQuery]) -> dict[str, GoldLabels]:
    return {
