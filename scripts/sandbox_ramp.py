...
async def run(args) -> int:
    ...
    try:
        ...
        from services.ingest.ingestion.workflows.source_onboarding import _LOAD_RAMP_INSTALL_SQL
        install_row = await pool.fetchrow(_LOAD_RAMP_INSTALL_SQL, _TENANT_ID)
