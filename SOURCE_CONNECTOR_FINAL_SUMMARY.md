...
`0190_source_connector_contract_only.sql` completes the pre-production cutover:
...
set and migration `0190`, run database-backed migration tests in an environment
