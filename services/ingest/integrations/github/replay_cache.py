"""services/ingest/integrations/github/replay_cache.py — in-process replay LRU.
...
Construction mirrors `services/app/webhooks/tenant_resolver.py::InstallationCache`
