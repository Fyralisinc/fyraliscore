"""services/ingest/integrations/github/uninstall.py — IN-13 uninstall chokepoint.
...
Structurally similar to `services/ingest/integrations/discord/uninstall.py::_disable_and_zeroize_discord`
