"""services/ingest/integrations/github/ — IN-13 GitHub App integration.
...
existing `services/app/webhooks/tenant_resolver.py::_extract_github`.

Public surface (consumed by `services/ingest/integrations/router.py` and
