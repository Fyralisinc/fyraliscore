"""Tests for services/ingest/integrations/google_calendar/onboarding.py (IN-15).
...
from services.ingest.integrations.google_calendar.onboarding import resolve_calendar_targets
