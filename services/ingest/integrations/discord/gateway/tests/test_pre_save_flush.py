...
See:
  ...
  - services/ingest/integrations/discord/gateway/client.py::_pre_save_flush
"""
...
class _FakeKafkaProducer:
    ...
    Surface mimics services/ingest/ingestion/kafka/producer.py::IdempotentProducer.flush
