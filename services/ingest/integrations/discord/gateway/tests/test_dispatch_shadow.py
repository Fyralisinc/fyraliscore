...
`services/ingest/integrations/discord/gateway/dispatch.py:handle_message_create`:
...
from services.ingest.ingestion.handlers.discord import handle_discord_message
