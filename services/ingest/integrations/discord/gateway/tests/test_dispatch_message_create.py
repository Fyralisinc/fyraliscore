...
from services.ingest.integrations.discord.gateway import metrics as gateway_metrics
from services.ingest.integrations.discord.gateway.dispatch import (
    DispatchDeps, handle_message_create,
)
from services.ingest.integrations.discord.gateway.tests.conftest import (
    make_message_create,
)
...
async def test_mentions_and_channel_in_metadata(
    ...
    from services.ingest.integrations.discord.gateway.tests.conftest import _TEST_GUILD_ID
