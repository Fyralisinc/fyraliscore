"""services/ingest/integrations/discord/gateway/metrics.py — IN-12 Gateway counters.

In-process counters/gauges scraped by structlog log emission. Matches the
shape of `services/ingest/integrations/discord/metrics.py` for consistency.
