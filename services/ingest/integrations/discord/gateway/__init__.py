"""services/ingest/integrations/discord/gateway — IN-12 Discord Gateway WSS worker.
...
Distinct from IN-09's Interactions HTTP path (services/ingest/integrations/discord/
...
ingestion handler at `services/ingest/ingestion/handlers/discord.py`.
