"""services.ingest.integrations.discord — Discord-specific OAuth, uninstall,
slash-command registration, and outbound REST client (Interactions
HTTP scope; Gateway WebSocket deferred to IN-12).

Sibling of services.ingest.integrations.slack with the same shape but three
load-bearing distinctions:

* Signatures use Ed25519 (not HMAC-SHA256) — verified via PyNaCl in
  services.app.webhooks.signatures.discord. Per-installation public key
