"""services/ingest/integrations/discord/uninstall.py — bot-kick chokepoint.
...
call goes through `services/ingest/integrations/discord/client.py`, and on a
...
This mirrors `services/ingest/integrations/slack/uninstall.py::_disable_and_zeroize`
