"""services/ingest/integrations/google_calendar/onboarding.py — install + provision.

Google Calendar reuses the Gmail DWD substrate (D1), so onboarding mirrors
Gmail's connect/finalize shape (services/ingest/integrations/gmail/oauth.py) rather
