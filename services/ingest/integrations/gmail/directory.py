"""services/ingest/integrations/gmail/directory.py — Directory-based mailbox enumeration.
...
from services.ingest.integrations.gmail.client import DirectoryClient
