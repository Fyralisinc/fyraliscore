"""services/ingest/integrations/gmail/watch.py — per-mailbox users.watch lifecycle.
...
- watch.expiration is set ~7d in the future by Gmail; the scheduler in
  services/ingest/integrations/gmail/watch_scheduler.py renews before expiry.
