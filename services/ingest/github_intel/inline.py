"""services/ingest/github_intel/inline.py — inline enrichment hook (raw-on-failure).

Called from `services.ingest.ingestion.core.ingest_from_draft` for every
...
async def _enrich(draft: Any, *, pool: Any, tenant_id: UUID, llm_enabled: bool) -> None:
    ...
    from services.ingest.github_intel.enrichment import build_inline_intelligence
