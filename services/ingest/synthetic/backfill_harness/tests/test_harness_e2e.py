...
backfill producer writes raw bodies to S3 before publishing). Run with:
    ...
    pytest services/ingest/synthetic/backfill_harness/tests/test_harness_e2e.py
...
async def test_harness_e2e_backfill_to_observation_chain(
    ...
    services/ingest/ingestion/normalizer/tests/test_backfill_external_id_parity.py;
