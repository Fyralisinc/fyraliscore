"""services/ingest/synthetic/core.py — direct injection API.
...
through services.ingest.ingestion.core.ingest() so that entity resolution,
...
from services.ingest.ingestion.core import IngestResult, ingest
