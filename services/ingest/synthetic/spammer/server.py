...
def _discord_router() -> APIRouter:
    ...
    async def gateway_bot() -> dict:
        ...
        # the local WSS mock (services/ingest/synthetic/spammer/discord_gateway.py)
...
def main() -> None:
    ...
    services.ingest.synthetic.spammer.server` (reads SPAMMER_PORT, default 9100,
    ...
    if workers > 1:
        ...
        uvicorn.run(
            "services.ingest.synthetic.spammer.server:build_spammer_app",
