...
in v1 (see `services/ingest/integrations/discord/gateway/dispatch.py` line
...
class DiscordGatewayGenerator:
    ...
    M4 tests build it — see `services/ingest/integrations/discord/gateway/
    ...
    async def simulate_message_update(
        ...
        *,
        ...
        `services/ingest/integrations/discord/gateway/dispatch.py` line
