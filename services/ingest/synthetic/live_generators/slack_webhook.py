...
from services.ingest.synthetic.mock_clients import MockSlackClient
from services.ingest.synthetic.scenarios import LiveSlackScenario, SlackTenantTraffic
...
class SlackWebhookGenerator:
    ...
    router mounted — build via `services.app.gateway.main.build_app`), the
