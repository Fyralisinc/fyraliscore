"""CLI: `python -m services.ingest.ingestion.recovery.embedding_backlog`.
...
from services.ingest.ingestion.recovery.embedding_backlog.embedding_backlog import main
