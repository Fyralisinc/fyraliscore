"""services/ingest/ingestion/workflows/oauth_poller.py
...
[services/ingest/ingestion/workflows/tests/test_executor_surface.py].
...
# ---------------------------------------------------------------------
# CLI entrypoint — `python -m services.ingest.ingestion.workflows.oauth_poller`.
# ---------------------------------------------------------------------
