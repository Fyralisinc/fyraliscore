...
(M3.3) and `services/ingest/integrations/discord/gateway/tests/test_gateway_lifecycle.py`
(M4.3 / A6 precedent).
...
services.ingest.ingestion.workflows`. It takes ~5-15 seconds — too slow for
