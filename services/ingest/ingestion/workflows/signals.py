"""services/ingest/ingestion/workflows/signals.py
...
============================================================
  ...
  - Claim-and-mark is one transaction. If the polling service crashes
    ...
    and `services/reasoning/think/post_commit.py` workers.
...
# `services/reasoning/think/post_commit.py::fetch_pending_actions` and the M1
...
async def poll_signals(
    ...
    *,
    ...
    # contract as `services/reasoning/think/post_commit.py`.
    for sig in signals:
        yield sig
