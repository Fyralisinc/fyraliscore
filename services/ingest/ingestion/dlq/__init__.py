"""services/ingest/ingestion/dlq — Dead-letter queue envelope + publish helpers.
...
The DLQ writer (`services.ingest.ingestion.writers.dlq_writer`) consumes
these envelopes and UPSERTs `ingestion_failures` rows.
"""
from services.ingest.ingestion.dlq.models import (
    DLQEnvelope,
    WireFailureKind,
)
from services.ingest.ingestion.dlq.publish import (
