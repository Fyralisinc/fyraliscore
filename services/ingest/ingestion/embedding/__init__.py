"""services/ingest/ingestion/embedding — embedding-needed signal envelope.
...
This package exports:
  ...
  - publish_embedding_request: best-effort publish helper used by the
    inline `services.ingest.ingestion.core.ingest` path AFTER an observation
    has been committed with `embedding_pending=TRUE`.

The embedding worker (`services.ingest.ingestion.writers.embedding_worker`)
