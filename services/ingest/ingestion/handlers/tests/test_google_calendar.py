"""Tests for services/ingest/ingestion/handlers/google_calendar.py (IN-15)."""
from __future__ import annotations

import pytest

from services.ingest.ingestion.handlers import CHANNEL_TRUST_MAP, get_handler
from services.ingest.ingestion.handlers.google_calendar import handle_google_calendar_event
