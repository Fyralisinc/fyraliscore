"""services/ingest/ingestion/handlers/gmail.py — Gmail message → ObservationDraft.
...
#   - `services.ingest.integrations.gmail.threading` (imports tenant_context)
#   - `lib.shared.tenant_context` (imports asyncpg)
#   - `services.ingest.ingestion.core` (imports asyncpg)
...
# CHANNEL_TRUST_MAP table at services/ingest/ingestion/handlers/__init__.py:41.
...
async def dispatch_gmail_message_resource(
    *,
    ...
    from services.ingest.ingestion.core import ingest as _ingest_core
    from services.ingest.integrations.gmail.threading import canonicalize_thread
