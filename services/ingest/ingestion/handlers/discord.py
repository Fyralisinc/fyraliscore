"""services/ingest/ingestion/handlers/discord.py — Discord ingestion handlers.
...
Two channels are registered here:
  ...
  `discord:interaction` — slash commands / components / modals received
    ...
    happens upstream in `services/app/webhooks/signatures/discord.py`; this
...
def _short_guild_hash(guild_id: str) -> str:
    ...
    Duplicated here (not imported from services/ingest/integrations/discord/
