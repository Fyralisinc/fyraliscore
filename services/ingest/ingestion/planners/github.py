"""services/ingest/ingestion/planners/github.py — GitHub backfill planner (M6.4).
...
[GithubClient.list_installation_repositories](../../../services/ingest/integrations/github/client.py)).
