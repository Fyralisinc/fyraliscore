"""services/ingest/ingestion/reconcilers/google_drive.py — gap detection (IN-16).
...
async def _open_drive_client(install: asyncpg.Record):  # noqa: ANN202
    from services.ingest.ingestion.fetchers.google_drive import _open_drive_client
