"""services/app/webhooks/signatures/notion.py — Notion HMAC SHA-256 verifier (IN-14 webhooks).
...
`NOTION_WEBHOOK_VERIFICATION_TOKEN` (see services/app/webhooks/secrets.py),
...
verification — see services/ingest/integrations/notion/webhook.py::is_verification_handshake.
"""
