...
def _register_routes(app: FastAPI) -> None:
    ...
    # services/product/recommendations/{repo,handlers}.py for the read/write
    ...
    # services/product/recommendations/watchers.py + migration 0027.
    ...
    # services.product.today.aggregator owns the substrate→UI mapping.
    @app.get("/v1/today")
    ...
    async def triage_recommendation_endpoint(
        ...
        from services.product.today import (
            TriageError,
