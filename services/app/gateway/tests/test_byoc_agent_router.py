    ...
    async def fetchrow(self, query: str, *args):
        ...
        if query_start.startswith("INSERT"):
            ...
            row = {
                ...
                "desired_config_epoch": args[9],
                "evidence_package_required": args[10],
                "heartbeat_interval_seconds": args[11],
                "telemetry_contract": args[12],
                "enrolled_at": args[13],
                "desired_state_updated_at": args[14],
                "desired_state_update_reason": args[15],
                "desired_state_updated_by": args[16],
                "stored_scope": args[17],
