"""services/app/realtime — Wave 4-D Realtime WebSocket service.
...
Python, not Rust: BUILD-PLAN top specifies Rust for services/app/realtime/,
...
from services.app.realtime.dispatcher import (  # noqa: F401
    Dispatcher,
    EventFrame,
    SubscriptionFilter,
)
from services.app.realtime.main import (  # noqa: F401
    realtime_router,
    RealtimeDeps,
    configure_realtime,
)
