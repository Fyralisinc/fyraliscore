"""services/domain/resources/partitions.py — monthly partition management for
`resource_transactions`.

BUILD-PLAN.md §3 Prompt 2.C: "services/domain/resources/partitions.py —
...
1-A's `services/domain/observations/partitions.py` — do NOT import it (that
