"""Tests for services/domain/resources/bridge.py — primitives."""
...
from services.domain.resources import bridge, customer_commitments as cc, deployments, repo
...
async def test_feasibility_owner_overload_is_warning(resources_db, event_id):
    from services.domain.resources.tests.conftest import make_actor
