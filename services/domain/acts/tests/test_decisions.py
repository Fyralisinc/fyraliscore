"""Integration tests for services/domain/acts/decisions.py."""
from __future__ import annotations

import pytest

from lib.shared.errors import InvariantViolation, ValidationError
from services.domain.acts import decisions
from services.domain.acts.tests.conftest import TENANT_A, TENANT_B, make_observation
