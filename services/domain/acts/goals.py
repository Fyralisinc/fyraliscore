"""
services/domain/acts/goals.py — Goal creation, transitions, acyclicity, and
...
from services.domain.acts.state_machines import can_transition, is_terminal
...
async def _emit_state_change(
    ...
    *,
    ...
    Deviation documented in BUILD-LOG: services/domain/observations/state_change.py
