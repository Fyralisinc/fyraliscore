"""
services/domain/models/recommendations.py — async cross-field validation for
recommendation-kind Models.

The Pydantic schema in `services.domain.models.propositions.RecommendationProposition`
...
they live here:
  ...
  2. **proposed_change.operation == 'transition' reachability**: when a
     ...
     Commitment state machine in `services.domain.acts.state_machines` must
...
async def validate_recommendation(
    ...
    *,
    ...
    `services.domain.models.propositions.validate_proposition`. This function
