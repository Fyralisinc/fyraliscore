"""
services/domain/models/tests/test_model_quality_suite.py — integration tests
...
from services.reasoning.relationships.candidates import TOPOLOGY_EMITTABLE_EDGE_KINDS
...
from services.reasoning.think.quality_gate import QualityContext, apply_verdict, score_quality
from services.reasoning.think.splitter import is_compound, split_compound_claim_op
...
# and services/reasoning/topology/tests/test_anchor.py. Not duplicated here.
