"""Tests for services/domain/observations/repo.py — integration + property.
...
from services.domain.observations.repo import (
    InvalidTrustTier,
    ObservationError,
...
async def test_semantic_search_finds_relevant(
    ...
    """
    from services.domain.observations.tests.conftest import _ollama_reachable
