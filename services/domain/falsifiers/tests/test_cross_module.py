"""
services/domain/falsifiers/tests/test_cross_module.py — Wave 4-C re-export regression.
...
from `services.domain.falsifiers` and gets byte-identical behaviour to the
authoritative `services.domain.models.falsifier` implementation.

Wave 1-C's tests in services/domain/models/tests/test_falsifier.py cover the
