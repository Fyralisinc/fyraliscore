"""
services/domain/falsifiers — authoritative falsifier adequacy package.
...
logic in services/domain/models/falsifier.py; this package re-exports that
module unmodified. Any change to the rules must land in
services/domain/models/falsifier.py (the authoritative implementation) and not
here.
...
Callers that still import from `services.domain.models.falsifier` continue to
