"""services/reasoning/think/tests/test_thresholds.py — pure-function threshold tests.
...
from services.reasoning.think.diff_schema import ActOp
from services.reasoning.think.thresholds import compute_threshold
