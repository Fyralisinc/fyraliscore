...
async def test_narrow_inferential_transactions_are_enabled_by_default(monkeypatch):
    ...
    monkeypatch.setenv("THINK_NARROW_INFERENTIAL_TX", "false")
    assert reason_mod._narrow_inferential_transaction_enabled() is False
    monkeypatch.setenv("THINK_NARROW_INFERENTIAL_TX", "off")
    assert reason_mod._narrow_inferential_transaction_enabled() is False
