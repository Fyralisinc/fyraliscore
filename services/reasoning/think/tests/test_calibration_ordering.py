"""services/reasoning/think/tests/test_calibration_ordering.py — TK-2 audit fix.

Source: THINK-DESIGN-AUDIT.md §5.2.

`services/domain/models/calibration.apply_calibration` CAN inflate confidence
...
async def test_inflating_calibration_requires_falsifier(fresh_db, tenant, tenant_cleanup):
    ...
    async with fresh_db.acquire() as conn:
        ...
        # adequate falsifier.
        from services.reasoning.think.validator import ValidationFailure
