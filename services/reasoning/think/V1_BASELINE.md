...
**Reconciler.** [services/reasoning/think/reconciler.py](reconciler.py) is single-pass, cosine-only. Thresholds (lines ~101-108):
...
**Retrieval.** [services/reasoning/retrieval/pathways.py](../../services/reasoning/retrieval/pathways.py) Pathway A is actor-scoped lookup via `obs_actor_time_idx`. It does not walk relationships. Hierarchy does not exist in retrieval.
