"""services/reasoning/sage/evidence_projection.py — Phase 8 Node-to-Evidence Projection.
...
* All DB I/O is performed via `pool` or an optional caller-supplied
  `conn`. Same convention as `services/reasoning/sage/inquiry_traces/repo.py`.
