"""services.reasoning.sage.model_predictions.repo — asyncpg repositories.

Schema reference: db/migrations/0089_sage_model_predictions.sql.

Two repos in this module — they share a connection-management pattern
with services.domain.models.repo (acquire-from-pool when no `conn` is passed,
...
installed by 0089 — so even if a caller forgets to wrap the call in
