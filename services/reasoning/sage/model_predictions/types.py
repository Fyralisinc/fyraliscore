"""services.reasoning.sage.model_predictions.types — Pydantic row types.

Mirrors the columns of `model_predictions` and `model_prediction_errors`
(migration 0089). These types are the exchange format between the
...
unrelated Pydantic shapes in services.product.forecasts (or similar).
Do not cross-import.
"""
