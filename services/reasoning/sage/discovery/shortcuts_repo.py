"""services/reasoning/sage/discovery/shortcuts_repo.py — Discovery Shortcuts repo (Phase 10).

Backing schema: db/migrations/0087_sage_discovery_and_negative_memory.sql.
...
(migration 0036 / 0087) is defense-in-depth — the repo NEVER relies on
...
from services.reasoning.sage.discovery.types import DiscoveryShortcut, Signature
...
class DiscoveryShortcutsRepo:
    ...
    # ------------------------------------------------------------------
    # Connection helper — mirrors services/reasoning/sage/affordances/repo.py
    # ------------------------------------------------------------------
