"""services.reasoning.sage.region_summaries.repo — asyncpg surface for region summaries.

Tenant-bound repo over `region_sufficient_state` (migration 0088).
...
deliberate divergence from `services.domain.models.repo.ModelsRepo`, which
...
def _jsonb(value: Any) -> str:
    ...
    diffs deterministic, matching `services.domain.models.repo._jsonb`.
    """
...
class RegionSummariesRepo:
    ...
    async def find_by_member_model(
        ...
        *,
        ...
        Uses the GIN index from migration 0088 — `@> ARRAY[$1]::uuid[]`
