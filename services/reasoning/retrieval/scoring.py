"""
services/reasoning/retrieval/scoring.py — Reciprocal Rank Fusion (RRF) scoring
for retrieval merge.

Source: RETRIEVAL-DESIGN-AUDIT §6 arguments 1-3. Replaces the linear
weighted-sum in `services/reasoning/retrieval/primary.py::_merge_and_rank_models`.
