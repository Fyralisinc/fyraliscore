"""
services/reasoning/retrieval/tests/_fixtures.py — hand-build the retrieval test
...
ModelsRepo, services.domain.acts.*, services.domain.resources.*) because the prompt
