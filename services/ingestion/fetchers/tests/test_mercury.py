"""Tests for services/ingestion/fetchers/mercury.py (finance)."""
from __future__ import annotations

import pytest

from services.ingestion.fetchers import mercury as mercury_fetcher
from services.ingestion.fetchers.mercury import (
    MercuryCursor,
