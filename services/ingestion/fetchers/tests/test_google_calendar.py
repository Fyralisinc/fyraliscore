"""Tests for services/ingestion/fetchers/google_calendar.py (IN-15)."""
...
from services.ingestion.fetchers import google_calendar as gc
from services.ingestion.fetchers.google_calendar import (
    SHARD_KIND_EVENTS,
