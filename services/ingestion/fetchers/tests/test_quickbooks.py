"""Tests for services/ingestion/fetchers/quickbooks.py (finance)."""
from __future__ import annotations

import pytest

from services.ingestion.fetchers import quickbooks as qbo_fetcher
from services.ingestion.fetchers.quickbooks import (
    QuickBooksCursor,
    SHARD_KIND_ENTITY,
