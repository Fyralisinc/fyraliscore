"""Tests for services/ingestion/planners/notion.py (IN-14)."""
...
from services.ingestion.planners import PLANNER_DISPATCH
from services.ingestion.planners.context import PlannerContext
from services.ingestion.planners.notion import (
    SHARD_KIND_DATABASE,
...
async def test_dispatch_wired():
    assert PLANNER_DISPATCH["notion"] is plan_shards_notion
