...
from services.ingestion.planners import slack as planner_mod
...
from services.synthetic.mock_clients import MockSlackUserClient
...
async def test_dm_channel_ids_match_inline_console_scheme(patch_user_clients):
    ...
    from services.gateway.slack_router import _dm_channel
