"""services/ingestion/reconcilers/jira.py — gap detection (IN-17).
...
async def _open_jira_client(install: asyncpg.Record):  # noqa: ANN202
    from services.ingestion.fetchers.jira import _open_jira_client
...
RECONCILER_DISPATCH["jira"] = reconcile_jira
