...
_PROCESSES: tuple[RuntimeProcess, ...] = (
    ...
    _proc(
        ...
        ("python", "scripts/run_think_worker.py"),
        ("production",),
        "Opt-in Reflex Think lane worker for deterministic and cheap triggers.",
        compose_service="think_worker_reflex",
        has_healthcheck=True,
    ),
    _proc(
        "think_worker_batch_memory",
        "reasoning",
        ("python", "scripts/run_think_worker.py"),
        ("production",),
        "Opt-in Batch Memory Think lane worker for T1 signal memory batches.",
        compose_service="think_worker_batch_memory",
        has_healthcheck=True,
    ),
    _proc(
        "think_worker_relationship",
        "reasoning",
        ("python", "scripts/run_think_worker.py"),
        ("production",),
        "Opt-in Relationship Think lane worker for T4 relationship candidates.",
        compose_service="think_worker_relationship",
        has_healthcheck=True,
    ),
    _proc(
        "think_worker_deep_synthesis",
        "reasoning",
        ("python", "scripts/run_think_worker.py"),
        ("production",),
        "Opt-in Deep Synthesis Think lane worker for broad inferential runs.",
        compose_service="think_worker_deep_synthesis",
        has_healthcheck=True,
    ),
    _proc(
        "think_worker_repair",
        ...
        ("python", "scripts/run_think_worker.py"),
        ("production",),
        "Opt-in Repair Think lane worker for validation and representation repair.",
        compose_service="think_worker_repair",
        has_healthcheck=True,
    ),
    _proc(
        "post_commit_worker",
    ...
    _proc(
        ...
        "perception-pipeline",
        ("python", "scripts/run_perception_pipeline_worker.py", "--role", "identity"),
        ("production",),
        "Resolves observation mentions and seals immutable identity snapshots.",
        compose_service="identity_resolution_worker",
        has_healthcheck=True,
    ),
    _proc(
        "perception_knowledge_worker",
        "perception-pipeline",
        ("python", "scripts/run_perception_pipeline_worker.py", "--role", "knowledge"),
        ("production",),
        "Extracts evidence-bound claims and seals immutable knowledge snapshots.",
        compose_service="perception_knowledge_worker",
        has_healthcheck=True,
    ),
    _proc(
        "episode_constructor_worker",
        "perception-pipeline",
        ("python", "scripts/run_perception_pipeline_worker.py", "--role", "episode"),
        ("production",),
        "Routes knowledge-settled observations into cross-source episodes.",
        compose_service="episode_constructor_worker",
        has_healthcheck=True,
    ),
    _proc(
        "episode_settlement_worker",
        "perception-pipeline",
        ("python", "scripts/run_perception_pipeline_worker.py", "--role", "settlement"),
        ("production",),
        "Settles quiet episodes and seals contradiction-preserving snapshots.",
        compose_service="episode_settlement_worker",
        has_healthcheck=True,
    ),
    _proc(
        "episode_handoff_worker",
        "perception-pipeline",
        ("python", "scripts/run_perception_pipeline_worker.py", "--role", "handoff"),
        ("production",),
        "Hands settled snapshots to reasoning under the ingress authority policy.",
        compose_service="episode_handoff_worker",
        has_healthcheck=True,
    ),
    _proc(
    ...
    _proc(
        ...
        "live-source",
        ("python", "scripts/run_connector_gateway_worker.py", "--source", "discord"),
        ("production",),
        "Discord Source Connector gateway session worker.",
    ...
    _proc(
        ...
        "live-source",
        ("python", "scripts/run_connector_gateway_worker.py", "--source", "telegram"),
        ("production",),
        "Telegram Source Connector gateway session worker.",
    ...
    _proc(
        ...
        "live-source",
        ("python", "scripts/run_connector_gateway_worker.py", "--source", "signal"),
        ("production",),
        "Signal Source Connector gateway session worker.",
    ...
    _proc(
        ...
        ("production",),
        "Gmail Source Connector watch scheduler.",
        compose_service="gmail_watch_scheduler",
        has_healthcheck=True,
    ),
    _proc(
        "connector_poll_worker",
        "live-source",
        ("python", "scripts/run_connector_poll_worker.py"),
        ("production",),
        "Incremental polling through Source Connector capabilities.",
        compose_service="connector_poll_worker",
        has_healthcheck=True,
    ),
    _proc(
        ...
        ("production",),
        "Google Calendar Source Connector watch scheduler.",
    ...
    _proc(
        ...
        ("production",),
        "Google Drive Source Connector watch scheduler.",
