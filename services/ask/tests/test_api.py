...
from services.ask.api import build_router
from services.ask.orchestrator import AskOrchestrator
from services.ask.schemas import AskScope
from services.ask.store import InMemoryAskStore
from services.ask.tests.test_orchestrator import _ConnProvider, _FakeReader
...
async def test_api_session_turn_and_evidence_expand(monkeypatch):
    ...
    monkeypatch.setattr(
        "services.ask.orchestrator.can_read",
        fake_can_read,
        raising=True,
    )
