"""services.sage.structural_features.repo — asyncpg repo.

Tenant-scoped CRUD over `model_structural_features` and
`model_edge_structural_features` (migration 0050). Pattern mirrors
`services/models/repo.py`: pool-owning repo, optional caller-supplied
connection for transactional use, tenant_id bound at construction.
"""
