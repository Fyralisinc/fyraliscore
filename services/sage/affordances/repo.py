"""services/sage/affordances/repo.py — Retrieval affordance profiles repo.

Backing schema: db/migrations/0051_sage_retrieval_affordance_profiles.sql.
...
(migration 0036 / 0051) is defense-in-depth — the repo NEVER relies on
