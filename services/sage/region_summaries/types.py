"""services.sage.region_summaries.types — Pydantic shapes for region summaries.

Mirrors the columns of `region_sufficient_state` (migration 0053).
...
class RegionSufficientState(BaseModel):
    ...
    table (none exists yet); see migration 0053 header. Loose-ref
