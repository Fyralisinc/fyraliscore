"""services/code_intel/indexer.py — build a code-graph snapshot from a working copy.
...
from services.code_intel.parsing import FileParse, get_indexer_for, supported_extensions
