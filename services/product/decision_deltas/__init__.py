"""
services/product/decision_deltas — first-class Decision Delta primitive.
...
The router is NOT wired into services/app/gateway/main.py here. The
registration line is documented in the agent report; main.py is in
the forbidden zone for this agent.
"""

from services.product.decision_deltas import apply, promote, repo, router  # noqa: F401
