"""Tests for services/product/query/classifier.py.
...
from services.product.query.classifier import (
    QueryClassifier,
    VALID_CATEGORIES,
    heuristic_classify,
)
from services.product.query.tests._helpers import ScriptedLLMProvider
