"""Shared fixtures for services/product/query tests. Most tests are
...
async def _isolate_caches():
    ...
    from services.product.query.classifier import get_default_cache
    from services.product.query.adapters import get_default_cache_adapter
