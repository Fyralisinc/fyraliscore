"""Test doubles shared across services/product/query tests."""
...
from services.product.query.classifier import QueryClassifier
from services.product.query.strategies.base import StrategyContext, StrategyResult
...
class ScriptedClassifier:
    ...
    async def classify(
        ...
        *,
        ...
        from services.product.query.classifier import ClassificationResult
