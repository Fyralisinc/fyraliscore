"""services.product.conversations.handler — probe → response orchestration.
...
probes route through services.product.query.QueryHandler with the card context
...
def _resolve_phrase(
    ...
    # segment (see _add_probe_markup in services.product.today.aggregator). We
...
def _resolve_chip(
    ...
    # the aggregator emits live in services.product.today.aggregator
