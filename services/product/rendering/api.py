"""services/product/rendering/api.py — FastAPI routes.
...
Request/response bodies mirror services/product/rendering/contracts.py with a
...
async def route_card_reasoning(
    ...
    GRT (`services/product/greeting/`) calls this per card after it has the
