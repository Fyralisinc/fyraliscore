"""services/product/rendering/contracts.py — request/response types for the service.
...
snapshot shape in `services/product/greeting/snapshot.py`; this module holds
...
class ModelRef:
    ...
    produces these from services/domain/models/; we accept unknown keys in
