"""services/product/demo/model_routing.py — per-tenant LLM model overrides.
...
from services.product.demo.repo import get_demo_config_by_id, get_tenant
...
async def resolve_model(
    ...
    *,
    ...
    convention is the same as `services.product.demo.budget.flush(call_kind=)`:
