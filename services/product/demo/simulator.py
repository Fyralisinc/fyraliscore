"""services/product/demo/simulator.py — signal injection from the demo UI panel.
...
real ingestion would produce, then routes through `services.ingest.ingestion.
core.ingest`.
...
`services/ingest/ingestion/handlers/<channel>.py` accepts. The simulator is a
...
from services.product.demo.repo import get_demo_session, increment_signal_count
...
import services.ingest.ingestion.handlers.email  # noqa: F401
import services.ingest.ingestion.handlers.github  # noqa: F401
import services.ingest.ingestion.handlers.calendar  # noqa: F401
import services.ingest.ingestion.handlers.system  # noqa: F401
...
# ready for `services.ingest.ingestion.core.ingest`.
