"""services/product/demo/tests/test_notifications_and_routing.py
...
from services.product.demo.model_routing import (
    determinism_seed_for_tenant,
    resolve_model,
)
from services.product.demo.notifications import should_suppress
from services.product.demo.repo import get_demo_config_by_company, upsert_tenant
