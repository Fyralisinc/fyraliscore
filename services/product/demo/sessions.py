"""services/product/demo/sessions.py — start / end / reset / inactivity sweep.
...
snapshot loading is provided by `services.product.demo.snapshot.load_snapshot`,
...
async def start_session(
    ...
    *,
    ...
    """
    from services.product.demo.snapshot import load_snapshot
...
async def reset_session(
    ...
    *,
    ...
    from services.product.demo.snapshot import load_snapshot, wipe_tenant
