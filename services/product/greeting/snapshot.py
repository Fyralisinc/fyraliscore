"""services/product/greeting/snapshot.py — Phase 2.
...
Sources:
  - Models        (services/domain/models/repo.py — high-conf recent state changes)
  - Commitments   (services/domain/acts/commitments.py — active, deadline pressure)
  - Resources     (services/domain/resources/repo.py — customer health)
  - state_changes (services/domain/observations/state_change.py — recency signal)
  - Anomalies     (services/reasoning/think/anomaly_integration.py → think_anomalies_raw)
  - conversation  (most recent CEO asks — wired from services/product/query/ when live;
                   empty until then)
...
class ConversationContext:
    """Recent CEO asks. Filled from services/product/query/ once Agent-QRY lands;
