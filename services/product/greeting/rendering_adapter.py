"""services/product/greeting/rendering_adapter.py — adapter into services/product/rendering/.
...
class HttpRenderingAdapter:
    """HTTP client pointing at services/product/rendering/api.py.
...
def _founder_to_rnd_wire(founder: FounderContext) -> dict[str, Any]:
    """Shape for services/product/rendering/api.py `FounderContextIn`."""
...
def _snapshot_to_rnd_wire(snapshot: SubstrateSnapshot) -> dict[str, Any]:
    ...
    `SubstrateSnapshotIn` shape in services/product/rendering/api.py.
