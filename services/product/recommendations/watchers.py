"""
services/product/recommendations/watchers.py — async repo for "Watch for revision"
...
dataclasses — to match the style of services/product/recommendations/repo.py
