"""services/integrations/google_drive/ — Google Drive ingestion source (IN-16).

Like Google Calendar (IN-15), Drive is a Google Workspace API that reuses the
SHARED Gmail Domain-Wide-Delegation substrate (services/integrations/gmail/
...
services/ingestion/{planners,fetchers,handlers,reconcilers}/google_drive.py.
"""
