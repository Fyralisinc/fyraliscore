"""services/github_intel/enrichment.py — assemble the causal context for a signal.
...
from services.github_intel.code_client import (
...
async def build_inline_intelligence(
    ...
    *,
    ...
    from services.github_intel.state_store import read_state_snapshot
