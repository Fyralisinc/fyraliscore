"""services/github_intel/api.py — read-only GitHub Intelligence HTTP surface.

Mounted by services/gateway/main.py via `app.include_router(build_github_intel_router())`.
...
from services.github_intel.read_repo import GithubIntelReadRepo
