"""services/think/quality_gate.py — model-quality scoring + verdict gate.
...
Integration order in services/think/applier.py:_apply_diff():
...
try:  # pragma: no cover - only used for type hints
    from services.think.reconciler import ReconcileResult  # type: ignore
...
try:
    from services.think.splitter import is_compound as _splitter_is_compound  # type: ignore
