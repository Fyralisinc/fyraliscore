"""Unit tests for services/gateway/slack_router.py synthetic DM generators.
...
from services.gateway.slack_router import (
    _dm_channel,
    _slack_dm_backfill_records,
    _slack_dm_live_event,
    build_slack_router,
)
from services.ingestion.handlers.slack import handle_slack_message
