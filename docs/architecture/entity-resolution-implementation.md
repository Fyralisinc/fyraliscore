...
| Initial assertion and access schema | `db/migrations/0192_identity_claims_and_evidence_access.sql` |
| Source-reference, mention, and run schema | `db/migrations/0194_entity_resolution_foundation.sql` |
| Candidate, constraint, and snapshot schema | `db/migrations/0195_entity_resolution_engine.sql` |
| Worker outbox and identity-aware episode gate | `db/migrations/0196_entity_resolution_orchestration.sql` |
