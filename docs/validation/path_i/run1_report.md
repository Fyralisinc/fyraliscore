...
**Status:** FAIL ❌
**Started:** 2026-06-07T09:51:33.198690+00:00
**Wall time:** 130.9s
**Tenants:** 4

## Pre-flight (fixture realism — Decision 12)

- gmail: 3 records, external_id='gmail:601dded4-7ae8-4764-b0e9-b8', occurred_at=2026-01-01T00:02:00+00:00 ✅
...
- ❌ `assert_all_complete` — 2 tenant(s) did NOT reach completion within the harness deadline: ['val-discord-0', 'val-github-0']. Either the deadline was too short OR the M6 chain stalled — check oauth_poller, shard_fetch, reconciler subprocess stderr in the result.
...
- `reconciler`: rc=1 — **UNEXPECTED (real failure)**
