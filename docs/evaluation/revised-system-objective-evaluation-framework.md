...
| Objective readiness v2 (`9bcfde1e`) | digest-bound v3, positive vertical and adversarial v2; continuous score `0.9901315789`, component coverage `1.0`, blocker verdict clear; workstream F1 `0.5` below `0.8` | Precise bounded state, not a release certificate; four graph attacks and two open-world cases cannot establish generalization |
