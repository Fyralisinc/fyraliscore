...
| Entity grounding, alias learning and relation topology | Opportunity/request/set/assessment/admission/work fates, trace integrity, pre-model versus persisted context equality, context-sufficiency admission fencing, exact predecessor/successor grounding plus answered-clarification authority for tenant-global alias mutation, four-entity exact-alias recurrence at `60/60`, four matched safety controls, candidate-memory lift across 24 variants, and evaluator-owned relation admission/non-admission, endpoint, type, direction, mention-lineage, unexpected-edge and harmful-propagation metrics; the sealed DB-backed company-physics vertical additionally populates five canonical links, two belief Models, two safe no-admissions and one directed exact-lineage relation | Focused grounded adjudication, exact replay and one bounded production-shaped canonical-to-topology path are proven. The populated vertical is too small to establish graph quality across adversarial wrong-link, wrong-direction, wrong-type, repair, multi-hop, open-world, load or company-scale populations. Novel entities and broader identity lifecycle transitions also remain unproven |
