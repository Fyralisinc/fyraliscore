...
breaker, Google Calendar install, Google Drive install, Jira install), 46 medium (8 resolved — Kafka full-pipeline persistence,
...
flow, and the Gmail Pub/Sub ingress mount), 64 low** — the high/medium are below; low
