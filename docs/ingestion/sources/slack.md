...
Self-serve OAuth ([services/integrations/slack/oauth.py](../../../services/integrations/slack/oauth.py)):
...
Outbound client [slack/client.py](../../../services/integrations/slack/client.py)
(`chat.postMessage`, `users.info`, `conversations.info`) honors 429
`Retry-After`. Uninstall ([slack/uninstall.py](../../../services/integrations/slack/uninstall.py))
...
([signatures/slack.py](../../../services/webhooks/signatures/slack.py)) → tenant
...
[planners/slack.py](../../../services/ingestion/planners/slack.py) enumerates
channels; [fetchers/slack.py](../../../services/ingestion/fetchers/slack.py)
...
[handlers/slack.py](../../../services/ingestion/handlers/slack.py) →
