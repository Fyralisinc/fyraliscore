...
-- file (0155_schema_migrations.sql) into the ledger after applying it, so the
...
COMMENT ON COLUMN schema_migrations.filename IS
  'Migration file name (e.g. 0155_schema_migrations.sql). The numeric prefix is the monotonic schema version reported as fyralis_schema_version.';
