...
-- 0191_prune_empty_out_of_window_partitions.sql
-- destructive-migration-approved: backup=not-required-empty-partitions rollback=partition-self-heal owner=platform
--
